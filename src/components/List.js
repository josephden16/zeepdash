...
const List = () => {
  ...
  useEffect(() => {
    ...
    const fetchRestaurants = async () => {
      ...
      if (cuisinesArray.length > 0) {
        ...
        const q = query(
          restaurantsRef,
          where("cuisines", "array-contains-any", cuisinesArray),
  ...
  return (
    <>
      ...
      {!restaurants && dataFetchingFailed === false && (
        <Loading text="Fetching restaurants..." />
      )}
  ...
  return (
    <Col md={4} sm={6} className="mb-4 pb-2">
      <CardItem
        ...
        imageAlt="Product"
        image={
          restaurant.imageURL ? restaurant.imageURL : "/img/default-list.webp"
        }
...
const seo = {
  ...
  metaDescription:
    "List of top restaurants near you that serve meals of various cuisines",
};
