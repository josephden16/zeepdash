								...
								<div className="restaurant-detailed-header-right text-right mt-2">
									...
									<div className="my-3">
										<button style={{ outline: "none", border: '0', background: 'transparent' }}>
											<a href={`whatsapp://send?text=Check out ${restaurant.name}'s page on ZeepDash, https://www.zeepdash.com/restaurants/${restaurant.slug}`} data-action="share/whatsapp/share">
										...
										<button style={{ outline: "none", border: '0', background: 'transparent' }}>
											<a target="_blank" rel="noreferrer" href={`https://twitter.com/intent/tweet?text=Check out ${restaurant.name}'s page on Zeepdash, https://www.zeepdash.com/restaurants/${restaurant.slug}`}>
