			...
			<div className="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
				<div className="list-card-image">
					...
					<Link to={this.props.linkUrl}>
						<Image src={this.props.image} loading="lazy" style={{ height: '170px', width: '100%' }} draggable={false} className={this.props.imageClass + " offer-img"} alt={this.props.imageAlt} />
					</Link>
				</div>
