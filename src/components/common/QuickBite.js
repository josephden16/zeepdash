      ...
      <div className={"p-3 border-bottom " + this.props.itemClass}>
        {this.state.quantity === 0 ?
          ...
          <span className="count-number float-right">
            <Button variant="outline-secondary" onClick={this.DecreaseItem} className="btn-sm left dec"> <HiOutlineMinusSm /> </Button>
            <input className="count-number-input" type="text" value={this.state.quantity} readOnly />
            <Button variant="outline-secondary" onClick={this.IncrementItem} className="btn-sm right inc"> <HiOutlinePlusSm /> </Button>
          </span>
        }
        <Media>
          {this.props.image ?
            ...
            :
            <div className="mr-3"><BsCircleFill className={"text-" + this.props.badgeVariant + " food-item"} /></div>
          }
          <Media.Body>
